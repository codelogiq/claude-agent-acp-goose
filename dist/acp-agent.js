...
export class ClaudeAcpAgent {
     ...
     */
    async handleAskUserQuestion(sessionId, toolInput, signal) {
        ...
        for (let i = 0; i < questions.length; i++) {
            ...
            if (q.header)
                messageLines.push(`**${q.header}**`);
            if (i === 0)
                messageLines.push(q.question);
        ...
        try {
            ...
            const response = await this.client.extMethod('session/elicitation', elicitationRequest);
